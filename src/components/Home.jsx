  ...
  return (
    <section id="home" className="box-border overflow-x-hidden ">
      ...
      <section id="menu" className="flex flex-col md:flex-row w-full max-w-6xl mx-auto px-4 overflow-hidden">
        {/* Men's Section */}
        <div id="menMenu" className="w-full md:w-1/3 p-4 " >
          <div className="w-full h-64 mb-4 cursor-pointer"  onClick={() => handleCategoryClick('men')}>
            <img 
              src={menimg} 
        ...
        {/* Kids Section */}
        <div id="kidMenu" className="w-full md:w-1/3 p-4">
          <div className="w-full h-64 mb-4 cursor-pointer"  onClick={() => handleCategoryClick('kid')}>
            <img 
              src={kidimg} 
        ...
        {/* Women's Section */}
        <div id="womanMenu" className="w-full md:w-1/3 p-4">
          <div className="w-full h-64 mb-4 cursor-pointer"  onClick={() => handleCategoryClick('woman')}>
            <img 
              src={womanimg} 
